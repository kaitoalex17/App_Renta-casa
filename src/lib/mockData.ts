...
export const INITIAL_PROPERTIES: PropertyData[] = [
  {
    ...
    commonAreas: 'Cocina de diseño equipada (2 frigoríficos combi, lavavajillas, horno, microondas), 2 baños compartidos de diseño, zona comedor/salón y cuarto de lavandería.',
    ...
    fixedExpenses: [
      { id: 'fe1', concept: 'Comunidad de Propietarios', amount: 95.0, frequency: 'MONTHLY' },
      { id: 'fe2', concept: 'IBI Anual', amount: 650.0, frequency: 'ANNUAL' },
      { id: 'fe3', concept: 'Seguro Multirriesgo e Impago', amount: 380.0, frequency: 'ANNUAL' },
      { id: 'fe4', concept: 'Fibra Óptica 1Gb Simétrica', amount: 39.99, frequency: 'MONTHLY' },
      { id: 'fe5', concept: 'Servicio Limpieza Zonas Comunes', amount: 160.0, frequency: 'MONTHLY' },
    ],
    units: [
      {
        id: 'unit_h1',
      ...
      },
      {
        ...
        currentContract: {
          ...
          endDate: '2026-02-28', // Fin primer cuatrimestre / temporal
        },
      },
      {
        id: 'unit_h3',
  ...
  },
  {
    ...
    generalRules: 'Alquiler temporal para trabajadores desplazados o nómadas digitales. Prohibido subarriendo turístico tipo Airbnb.',
    ...
    coOwners: [],
    fixedExpenses: [
      { id: 'fe10', concept: 'Comunidad Mensual', amount: 55.0, frequency: 'MONTHLY' },
      { id: 'fe11', concept: 'IBI Anual', amount: 380.0, frequency: 'ANNUAL' },
      { id: 'fe12', concept: 'Seguro Hogar', amount: 220.0, frequency: 'ANNUAL' },
    ],
    units: [
      {
        id: 'unit_apt1',
        ...
        baseRent: 950.0,
        depositAmount: 950.0,
        utilityCap: 0.0, // Repercusión íntegra
...
export const INITIAL_CONTRACTS: ContractData[] = [
  ...
  },
  {
    ...
    temporalCauseDetail: 'Contrato laboral por circunstancias de la producción para proyecto tecnológico de 5 meses en Madrid.',
...
export const INITIAL_UTILITY_BILLS: UtilityBillData[] = [
  {
    ...
    totalAmount: 169.0,
    invoicePdfUrl: 'https://ejemplo.com/factura-luz-sep2025.pdf',
    charges: [
      {
        contractId: 'ct_juan',
        tenantName: 'Juan Martínez',
...
export const INITIAL_NOTICES: FormalNoticeData[] = [
  {
    ...
    message: 'Estimados inquilinos: el próximo jueves entre las 10:00 y las 12:00 h acudirá el técnico autorizado de Gas Natural para la revisión reglamentaria obligatoria de la caldera comunitaria.',
